...
#################################################
macro (robocup3ds_add_library _name)
  add_library(${_name} SHARED ${ARGN})
  target_link_libraries (${_name} ${general_libraries})
endmacro ()

#################################################
macro (robocup3ds_add_static_library _name)
  add_library(${_name} STATIC ${ARGN})
  target_link_libraries (${_name} ${general_libraries})
endmacro ()

#################################################
macro (robocup3ds_add_executable _name)
...
#################################################
macro (robocup3ds_install_includes _subdir)
  install(FILES ${ARGN} DESTINATION ${INCLUDE_INSTALL_DIR}/${_subdir} COMPONENT headers)
endmacro()

#################################################
macro (robocup3ds_install_library _name)
...
#################################################
macro (robocup3ds_install_executable _name)
...
#################################################
macro (robocup3ds_setup_unix)
endmacro()

#################################################
macro (robocup3ds_setup_windows)
endmacro()

#################################################
macro (gazebo-robocup3d_setup_apple)
