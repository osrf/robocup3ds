...
function(setup_target_for_coverage _targetname _outputname)
  ...
  add_custom_target(${_targetname}
    COMMAND ${LCOV_PATH} -q --zerocounters --directory ${PROJECT_BINARY_PATH}/src
    # Capturing lcov counters and generating report
    COMMAND ${LCOV_PATH} --quiet --no-checksum --directory ${PROJECT_BINARY_DIR}/src --capture --output-file ${_outputname}.info 2>/dev/null
    COMMAND ${LCOV_PATH} -q --remove ${_outputname}.info 'build/*' 'test/*' '/usr/*' --output-file ${_outputname}.info.cleaned
