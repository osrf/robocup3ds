...
//////////////////////////////////////////////////
void Server::messagePassing(int sock) {
    agentNo = clientCounter;
    ...
    while (1) {
        ...
        receivingMessage = string(buffer);
        ...
        ssize_t bytes_written = write(sock, sendingMessage.str().c_str(),
                MBUFFERSIZE);
        if (bytes_written < 0)
