...
class NaoSimsparkBT : public NaoBT
{
  ...
  hingeJointPIDMap =
  {
      {"HeadYaw", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"HeadPitch", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"LShoulderPitch", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"LShoulderRoll", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"LElbowYaw", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"LElbowRoll", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"LHipYawPitch", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"LHipRoll", gazebo::common::PID(160, 160, 0, -1, 10, -10)},
      {"LHipPitch", gazebo::common::PID(400, 400, 0, 1, -1, 10, -10)},
      {"LKneePitch", gazebo::common::PID(400, 400, 0, 1, -1, 10, -10)},
      {"LAnklePitch", gazebo::common::PID(400, 400, 0, 1, -1, 10, -10)},
      {"LAnkleRoll", gazebo::common::PID(160, 160, 0, -1, 10, -10)},
      {"RHipYawPitch", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"RHipRoll", gazebo::common::PID(160, 160, 0, -1, 10, -10)},
      {"RHipPitch", gazebo::common::PID(400, 400, 0, 1, -1, 10, -10)},
      {"RKneePitch", gazebo::common::PID(400, 400, 0, 1, -1, 10, -10)},
      {"RAnklePitch", gazebo::common::PID(400, 400, 0, 1, -1, 10, -10)},
      {"RAnkleRoll", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"RShoulderPitch", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"RShoulderRoll", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)},
      {"RElbowYaw", gazebo::common::PID(160, 160, 0, -1, 10, -10)},
      {"RElbowRoll", gazebo::common::PID(160, 160, 0, 1, -1, 10, -10)}
  };
};
