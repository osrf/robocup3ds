...
class GameState
{
  ...
  public: static const double SecondsFullGame;
  /// \brief Duration of a half
  public: static const double SecondsEachHalf;
  /// \brief Duration of pause after goal
  public: static const double SecondsGoalPause;
  /// \brief Duration of pause after transition to kickIn
  public: static const double SecondsKickInPause;
  /// \brief Duration of kickIn mode
  public: static const double SecondsKickIn;
  /// \brief Duration of beforeKickOff mode
  public: static const double SecondsBeforeKickOff;
  /// \brief Duration of kickOff mode
  public: static const double SecondsKickOff;
  /// \brief Radius where not allowed team cannot approach ball
  public: static const double dropBallRadius;
  /// \brief Every cycle counts as 20ms of game time (for `fake simulations)
  public: static const bool useCounterForGameTime;
  /// \brief Max players per team
  public: static const int playerLimit;
  /// \brief Max players in penalty box
  public: static const int penaltyBoxLimit;
  /// \brief Beam height
  public: static const double beamHeight;
  /// \brief Distance when to enable crowding rules
  public: static const double crowdingEnableDist;
  /// \brief Distance when to reposition one of two players
  public: static const double crowdingReposDist2;
  /// \brief Distance when to reposition one of three players
  public: static const double crowdingReposDist3;
  /// \brief Timeout when player remains immobile too long
  public: static const double immobilityTimeLimit;
  /// \brief Timeout when player remains fallen too long
  public: static const double fallenTimeLimit;
